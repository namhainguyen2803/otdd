...
def compute_otdd_distance(maxsamples=MAXSIZE_DIST, METADATA_DATASET=None, device="cpu"):
...
def compute_otdd_gaussian_distance(maxsamples=MAXSIZE_DIST, METADATA_DATASET=None, device="cpu"):
...
def compute_wte_distance(maxsamples=MAXSIZE_DIST, METADATA_DATASET=None, device="cpu"):
    ...
    wtes = WTE(subdatasets, label_dim=10, device=device, ref=reference.cpu(), maxsamples=maxsamples)
...
def compute_hswfs_distance(maxsamples=MAXSIZE_DIST, METADATA_DATASET=None, num_proj=500, device="cpu"):
    ...
    emb = LabelsBW(device=device, maxsamples=maxsamples)
