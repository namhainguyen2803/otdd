#!/bin/bash -e
#SBATCH --job-name=num_split2
#SBATCH --output=/lustre/scratch/client/vinai/users/hainn14/otdd/num_split2.out
#SBATCH --error=/lustre/scratch/client/vinai/users/hainn14/otdd/num_split2.err
#SBATCH --nodes=1
