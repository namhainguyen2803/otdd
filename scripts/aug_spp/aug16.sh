#!/bin/bash -e
#SBATCH --job-name=aug16
#SBATCH --output=/lustre/scratch/client/vinai/users/hainn14/otdd/aug16.out
#SBATCH --error=/lustre/scratch/client/vinai/users/hainn14/otdd/aug16.err
#SBATCH --nodes=1
