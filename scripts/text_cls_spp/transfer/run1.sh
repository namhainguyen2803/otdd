...
#SBATCH --output=/lustre/scratch/client/vinai/users/hainn14/otdd/trans_run12.out
#SBATCH --error=/lustre/scratch/client/vinai/users/hainn14/otdd/trans_run12.err
#SBATCH --nodes=1
