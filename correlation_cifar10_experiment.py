...
def main():
    ...
    parser.add_argument('--parent_dir', type=str, default="saved_corr_cifar10_projection_v100_4", help='Parent directory')
    ...
    for idx in range(len(list_dataset_size)):
        ...
        # NEW METHOD
        projection_list = [100] + [1000 * (i + 1) for i in range(50)]
